    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        ...
        <p className="mt-3 max-w-2xl text-base text-muted-foreground">
          Assemble the key terms on an EFET-based confirmation and have AI flag any off-market terms.
        </p>
          ...
          <>
            <div className="mt-6 flex flex-wrap items-center justify-between gap-3 rounded-lg border border-border bg-secondary/40 px-4 py-3">
              <div className="text-sm">
                ...
                <span className="text-muted-foreground"> · {cfg.market.hub} · EFET General Agreement</span>
              </div>
              <button
                onClick={runContract}
